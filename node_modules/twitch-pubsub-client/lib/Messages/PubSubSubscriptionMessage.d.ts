...
export declare class PubSubSubscriptionMessage {
    ...
    /** @private */
    constructor(_data: PubSubSubscriptionMessageData, apiClient: ApiClient);
    /**
     ...
     */
    get subPlan(): "Prime" | "1000" | "2000" | "3000";
    /**
     ...
     * @deprecated Use {@HelixUserApi#getUserById} instead.
     */
    getGifter(): Promise<import("twitch/lib").HelixUser | null>;
}
