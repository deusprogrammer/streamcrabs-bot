 ...
 */
export declare class ChannelPlaceholder {
    /** @private */
     ...
     */
    getCheermotes(): Promise<import("../Bits/CheermoteList").CheermoteList>;
    /**
     ...
     */
    getFollowers(): Promise<import("./ChannelFollow").ChannelFollow[]>;
    /**
     * Retrieves the channel's subscribers.
     */
    getSubscriptions(): Promise<import("./ChannelSubscription").ChannelSubscription[]>;
    /**
     ...
     */
    getSubscriptionBy(user: UserIdResolvable): Promise<import("./ChannelSubscription").ChannelSubscription | null>;
    /**
