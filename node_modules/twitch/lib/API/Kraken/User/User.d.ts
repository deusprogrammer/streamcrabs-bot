...
export declare class User {
    ...
    /** @private */
    constructor(/** @private */ _data: UserData, client: ApiClient);
    /** @private */
    get cacheKey(): string;
    /**
     * The ID of the user.
     ...
     */
    getChannel(): Promise<import("../Channel/Channel").Channel>;
    /**
     ...
     */
    getStream(): Promise<import("../Stream/Stream").Stream | null>;
    /**
     ...
     */
    getSubscriptionTo(channel: UserIdResolvable): Promise<import("./UserSubscription").UserSubscription | null>;
    /**
     ...
     */
    getFollows(page?: number, limit?: number, orderBy?: 'created_at' | 'last_broadcast' | 'login', orderDirection?: 'asc' | 'desc'): Promise<import("./UserFollow").UserFollow[]>;
    /**
     * Retrieves the follow data of the user to a given channel.
     *
     * @param channel The channel to retrieve the follow data for.
     */
    getFollowTo(channel: UserIdResolvable): Promise<import("./UserFollow").UserFollow | null>;
    /**
     ...
     */
    follow(): Promise<import("./UserFollow").UserFollow>;
    /**
     ...
     */
    getEmotes(): Promise<import("../Channel/EmoteSetList").EmoteSetList>;
}
