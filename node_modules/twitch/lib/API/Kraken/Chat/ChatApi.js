        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new ChatEmoteList_1.ChatEmoteList(data.emoticons, this._client)];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.rooms.map(function (room) { return new ChatRoom_1.ChatRoom(room, _this._client); })];
                }
            });
        });
    };
