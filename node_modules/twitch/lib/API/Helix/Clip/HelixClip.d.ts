...
export declare class HelixClip {
    ...
    /** @private */
    constructor(_data: HelixClipData, client: ApiClient);
    /**
     * The clip ID.
     */
    get id(): string;
     ...
     */
    getBroadcaster(): Promise<import("../User/HelixUser").HelixUser | null>;
    /**
     ...
     */
    getCreator(): Promise<import("../User/HelixUser").HelixUser | null>;
    /**
     ...
     */
    getVideo(): Promise<import("../Video/HelixVideo").HelixVideo | null>;
    /**
     ...
     */
    getGame(): Promise<import("../Game/HelixGame").HelixGame | null>;
    /**
