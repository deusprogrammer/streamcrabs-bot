...
export declare class HelixClipApi extends BaseApi {
     ...
     * @expandParams
     */
    getClipsForBroadcaster(userId: string, filter?: HelixClipFilter): Promise<import("../HelixPaginatedResult").HelixPaginatedResult<HelixClip>>;
    /**
     ...
     * @expandParams
     */
    getClipsForGame(gameId: string, filter?: HelixClipFilter): Promise<import("../HelixPaginatedResult").HelixPaginatedResult<HelixClip>>;
    /**
