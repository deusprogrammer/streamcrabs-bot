...
export declare class HelixModerationApi extends BaseApi {
     ...
     */
    getBannedUsers(channel: UserIdResolvable, filter?: HelixBanFilter): Promise<import("../HelixPaginatedResult").HelixPaginatedResult<HelixBan>>;
    /**
     ...
     * @param filter Additional filters for the result set.
     */
    getModerators(channel: UserIdResolvable, filter?: HelixModeratorFilter): Promise<import("../HelixPaginatedResult").HelixPaginatedResult<HelixModerator>>;
    /**
     ...
     * @param filter Additional filters for the result set.
     */
    getModeratorEvents(channel: UserIdResolvable, filter?: HelixModeratorFilter): Promise<import("../HelixPaginatedResult").HelixPaginatedResult<HelixModeratorEvent>>;
    /**
