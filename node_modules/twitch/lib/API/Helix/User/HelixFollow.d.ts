...
export declare class HelixFollow {
    ...
    /** @private */
    constructor(/** @private */ _data: HelixFollowData, client: ApiClient);
    /**
     ...
     */
    getUser(): Promise<import("./HelixUser").HelixUser | null>;
    /**
     ...
     */
    getFollowedUser(): Promise<import("./HelixUser").HelixUser | null>;
    /**
