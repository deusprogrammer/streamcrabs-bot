 ...
 * A Twitch user.
 */
export declare class HelixUser {
    protected _data: HelixUserData;
    /** @private */
    protected readonly _client: ApiClient;
    /** @private */
    constructor(/** @private */ _data: HelixUserData, client: ApiClient);
    /** @private */
    get cacheKey(): string;
    /**
     * The ID of the user.
     ...
     */
    getStream(): Promise<import("../Stream/HelixStream").HelixStream | null>;
    /**
     * Retrieves a list of broadcasters the user follows.
     */
    getFollows(): Promise<import("../HelixPaginatedResult").HelixPaginatedResultWithTotal<import("./HelixFollow").HelixFollow>>;
    /**
     * Retrieves the follow data of the user to the given broadcaster.
     *
     * @param broadcaster The broadcaster to check the follow to.
     */
    getFollowTo(broadcaster: UserIdResolvable): Promise<import("./HelixFollow").HelixFollow | null>;
    /**
     ...
     */
    getSubscriptionTo(broadcaster: UserIdResolvable): Promise<import("../Subscriptions/HelixSubscription").HelixSubscription | null>;
    /**
